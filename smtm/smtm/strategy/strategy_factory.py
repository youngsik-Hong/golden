...
# from .strategy_bbi_v3_spec_v1 import StrategyBBI_V3_Spec_V1
# from .strategy_bbi_v3_spec_v1_test import StrategyBBI_V3_Spec_V1_Test
# from .strategy_bbi_v3_spec_v15 import StrategyBBI_V3_Spec_V15
from .strategy_bbi_v3_spec_v16_vol import StrategyBBI_V3_Spec_V16_Vol
...
class StrategyFactory:
    ...
    STRATEGY_LIST = [
        ...
        StrategySas,
        StrategyHey,
        # StrategyBBI_V3_Spec_V1,
        # StrategyBBI_V3_Spec_V1_Test,
        # StrategyBBI_V3_Spec_V15,
        StrategyBBI_V3_Spec_V16_Vol,
    ]
